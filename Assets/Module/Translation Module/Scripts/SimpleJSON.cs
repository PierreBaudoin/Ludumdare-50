...
namespace SimpleJSON {
    ...
    public abstract class JSONNode {
        ...
        static JSONData Numberize(string token) {
            ...
            if (float.TryParse(token, out real)) {
            ...
            if (double.TryParse(token, out highReal)) {
                return new JSONData(highReal);
            }
            
            if (long.TryParse(token, out highInteger)){
                return new JSONData(highInteger);
            }
